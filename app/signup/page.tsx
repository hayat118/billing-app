...
const SignupPage = () => {
  ...
  return (
    <div className="min-h-screen flex bg-[radial-gradient(circle_at_top_left,_rgba(20,184,166,0.12),_transparent_32%),linear-gradient(135deg,_#f4fbf8_0%,_#eefbf7_100%)]">
      {/* Left Side - Image/Branding */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-teal-700 via-emerald-700 to-cyan-700 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full px-12 text-white">
          ...
          <p className="text-xl text-teal-50 text-center mb-8">
            Join our billing platform and manage your business efficiently.
          </p>
          ...
          <div className="grid grid-cols-3 gap-6 mt-12">
            <div className="text-center">
              ...
              <p className="text-sm">Free Setup</p>
            </div>
            <div className="text-center">
              <div className="bg-white bg-opacity-20 rounded-full p-4 mb-3 inline-block">
                <svg
              ...
              <p className="text-sm">Easy Billing</p>
            </div>
            <div className="text-center">
              <div className="bg-white bg-opacity-20 rounded-full p-4 mb-3 inline-block">
                <svg
              ...
              <p className="text-sm">Customer Management</p>
            </div>
          </div>
        </div>
